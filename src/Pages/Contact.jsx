...
const Contact = () => {
  ...
  <div className="w-full md:w-1/2 flex contactFirstDiv flex-col justify-center p-8 md:p-16">
    <h3 className="text-[30px] md:text-[40px] font-bold mt-10 contactText font-DM mb-10">I am from Bangladesh, Dhaka, Narsingdi</h3>
  ...
  <div className=" md:flex  md:flex-row md:items-center md:relative md:justify-end md:w-1/2 md:p-8">
    <div className="w-full md:w-auto h-auto md:absolute md:bottom-[72px] ">
